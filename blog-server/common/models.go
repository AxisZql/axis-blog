...
type TArticle struct {
	...
	ArticleCover   string    `json:"article_cover,omitempty" remark:"文章封面" gorm:"type:varchar;size:1024"`
	ArticleTitle   string    `json:"article_title,omitempty" remark:"标题" gorm:"type:varchar;size:50;not null"`
	...
	OriginalUrl    string    `json:"original_url,omitempty" remark:"原文链接" gorm:"type:varchar;size:255"`
...
type TCategory struct {
	ID           int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	CategoryName string    `json:"category_name,omitempty" remark:"分类名" gorm:"type:varchar;size=20;not null"`
...
type TTag struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	TagName    string    `json:"tag_name,omitempty" remark:"标签名" gorm:"type:varchar;size:20;not null"`
	CreateTime time.Time `json:"create_time,omitempty" remark:"创建时间" gorm:"type:datetime;default:current_timestamp;not null"`
	UpdateTime time.Time `json:"update_time,omitempty" remark:"更新时间" gorm:"type:datetime;default:current_timestamp;not null"`
}
...
type TChatRecord struct {
	...
	Nickname   string    `json:"nickname,omitempty" remark:"用户昵称" gorm:"type:varchar;size:50;not null"`
	Avatar     string    `json:"avatar,omitempty" remark:"用户头像" gorm:"type:varchar;size:255;not null"`
	Content    string    `json:"content,omitempty" remark:"聊天内容" gorm:"type:varchar;size:1024;not null"`
	IpAddress  string    `json:"ip_address,omitempty" remark:"ip地址" gorm:"type:varchar;size=50;not null"`
	IpSource   string    `json:"ip_source,omitempty" remark:"ip来源" gorm:"type:varchar;size:255;not null"`
...
type TFriendLink struct {
	ID          int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	LinkName    string    `json:"link_name,omitempty" remark:"链接名" gorm:"type:varchar;size:20;not null"`
	LinkAvatar  string    `json:"link_avatar,omitempty" remark:"链接头像" gorm:"type:varchar;size:255;not null"`
	LinkAddress string    `json:"link_address,omitempty" remark:"链接地址" gorm:"type:varchar;size:50;not null"`
	LinkIntro   string    `json:"link_intro,omitempty" remark:"链接介绍" gorm:"type:varchar;size:100;not null"`
	CreateTime  time.Time `json:"create_time,omitempty" remark:"创建时间" gorm:"type:datetime;default:current_timestamp;not null"`
	UpdateTime  time.Time `json:"update_time,omitempty" remark:"更新时间" gorm:"type:datetime;default:current_timestamp;not null"`
}
...
type TMenu struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	Name       string    `json:"name,omitempty" remark:"菜单名" gorm:"type:varchar;size:20;not null"`
	Path       string    `json:"path,omitempty" remark:"菜单路径" gorm:"type:varchar;size:50;not null"`
	Component  string    `json:"component,omitempty" remark:"组件" gorm:"type:varchar;size=50;not null"`
	Icon       string    `json:"icon,omitempty" remark:"菜单icon" gorm:"type:varchar;size:50;not null"`
...
type TMessage struct {
	...
	Nickname       string    `json:"nickname,omitempty" remark:"用户昵称" gorm:"type:varchar;size:50;not null"`
	Avatar         string    `json:"avatar,omitempty" remark:"用户头像" gorm:"type:varchar;size:255;not null"`
	MessageContent string    `json:"message_content,omitempty" remark:"留言内容" gorm:"type:varchar;size:255;not null"`
	IpAddress      string    `json:"ip_address,omitempty" remark:"ip地址" gorm:"type:varchar;size=50;not null"`
	IpSource       string    `json:"ip_source,omitempty" remark:"ip来源" gorm:"type:varchar;size:255;not null"`
...
type TOperationLog struct {
	ID            int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	OptModule     string    `json:"opt_module,omitempty" remark:"操作模块" gorm:"type:varchar;size:20;not null"`
	OptType       string    `json:"opt_type,omitempty" remark:"操作类型" gorm:"type:varchar;size:20;not null"`
	OptUrl        string    `json:"opt_url,omitempty" remark:"操作url" gorm:"type:varchar;size:255;not null"`
	OptMethod     string    `json:"opt_method,omitempty" remark:"操作方法" gorm:"type:varchar;size:255;not null"`
	OptDesc       string    `json:"opt_desc,omitempty" remark:"操作描述" gorm:"type:varchar;size:255;not null"`
...
type TPage struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	PageName   string    `json:"page_name,omitempty" remark:"页面名称" gorm:"type:varchar;size:10;not null"`
	PageLabel  string    `json:"page_label,omitempty" remark:"页面标签" gorm:"type:varchar;size:20"`
	PageCover  string    `json:"page_cover,omitempty" remark:"页面封面" gorm:"type:varchar;size:255;not null"`
	CreateTime time.Time `json:"create_time,omitempty" remark:"创建时间" gorm:"type:datetime;default:current_timestamp;not null"`
	UpdateTime time.Time `json:"update_time,omitempty" remark:"更新时间" gorm:"type:datetime;default:current_timestamp;not null"`
}
...
type TPhoto struct {
	...
	PhotoName  string    `json:"photo_name,omitempty" remark:"照片名" gorm:"type:varchar;not null"'`
	PhotoDesc  string    `json:"photo_desc,omitempty" remark:"照片描述" gorm:"type:varchar;size:50"`
	PhotoSrc   string    `json:"photo_src" remark:"照片地址" gorm:"type:varchar;size:255;not null"`
	IsDelete   int       `json:"is_delete,omitempty" remark:"是否删除 0否 1是" gorm:"type:tinyint;default:0;not null"`
	CreateTime time.Time `json:"create_time,omitempty" remark:"创建时间" gorm:"type:datetime;default:current_timestamp;not null"`
	UpdateTime time.Time `json:"update_time,omitempty" remark:"更新时间" gorm:"type:datetime;default:current_timestamp;not null"`
}
...
type TPhotoAlbum struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	AlbumName  string    `json:"album_name,omitempty" remark:"相册名" gorm:"type:varchar;size:20;not null"`
	AlbumDesc  string    `json:"album_desc,omitempty" remark:"相册描述" gorm:"type:varchar;size:50;not null"`
	AlbumCover string    `json:"album_cover,omitempty" remark:"相册封面" gorm:"type:varchar;size:255;not null"`
...
type TResource struct {
	ID            int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	ResourceName  string    `json:"resource_name,omitempty" remark:"资源名" gorm:"type:varchar;size:50;not null"`
	Url           string    `json:"url,omitempty" remark:"权限路径" gorm:"type:varchar;size:255"`
	RequestMethod string    `json:"request_method" remark:"请求方式" gorm:"type:varchar;size:10"`
...
type TRole struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	RoleName   string    `json:"role_name,omitempty" remark:"角色名" gorm:"type:varchar;size:20;not null"`
	RoleLabel  string    `json:"role_label,omitempty" remark:"角色描述" gorm:"type:varchar;size:50;not null"`
...
type TTalk struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	UserId     int64     `json:"user_id,omitempty" remark:"用户id" gorm:"type:bigint;not null"`
	Content    string    `json:"content,omitempty" remark:"说说内容" gorm:"type:varchar;size:2000;not null"`
	Images     string    `json:"images,omitempty" remark:"说说图片" gorm:"type:varchar;size:2500"`
...
type TUserAuth struct {
	...
	Username      string    `json:"username,omitempty" remark:"用户名" gorm:"type:varchar;size:50;not null"`
	Password      string    `json:"password,omitempty" remark:"密码" gorm:"type:varchar;size:255;not null"`
...
type TUserInfo struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	Email      string    `json:"email,omitempty" remark:"邮箱号" gorm:"type:varchar;size:50"`
	Nickname   string    `json:"nickname,omitempty" remark:"用户昵称" gorm:"type:varchar;size:50;not null"`
	Avatar     string    `json:"avatar,omitempty" remark:"用户头像" gorm:"type:varchar;size:255;not null"`
	Intro      string    `json:"intro,omitempty" remark:"用户简介" gorm:"type:varchar;size:255"`
	WebSite    string    `json:"web_site" remark:"个人网站" gorm:"type:varchar;size:255"`
	IsDisable  int       `json:"is_disable,omitempty" remark:"是否禁用 0否 1是" gorm:"type:tinyint;default:0;not null"`
	CreateTime time.Time `json:"create_time,omitempty" remark:"创建时间" gorm:"type:datetime;default:current_timestamp;not null"`
	UpdateTime time.Time `json:"update_time,omitempty" remark:"更新时间" gorm:"type:datetime;default:current_timestamp;not null"`
}
...
type TWebsiteConfig struct {
	ID         int64     `json:"id,omitempty" remark:"自增id" gorm:"primary_key"`
	Config     string    `json:"config,omitempty" remark:"配置信息" gorm:"type:varchar;size:1000"`
	CreateTime time.Time `json:"create_time,omitempty" remark:"创建时间" gorm:"type:datetime;default:current_timestamp;not null"`
	UpdateTime time.Time `json:"update_time,omitempty" remark:"更新时间" gorm:"type:datetime;default:current_timestamp;not null"`
}
